...
SNIPPET_VillageGenerated("mod_a_piglin_setup", (villageId) => {
    ...
    for (let i = 0; i < 18; i++) {
        ...
        if (QUERY_RandomNumberGroup(0, 3, "height_spin") < 1) {
            DECK_MultiplyBySingle(padding, ZoneHeightChangeCard("def14Height"))
        } else {
            DECK_MultiplyBySingle(padding, ZoneHeightChangeCard("def20Height"))
        }
    ...
    for (let i = 0; i < 18; i++) {
        ...
        if (QUERY_RandomNumberGroup(0, 3, "height_spin") < 1) {
            DECK_MultiplyBySingle(secondPadding, ZoneHeightChangeCard("def7Height"))
        } else {
            DECK_MultiplyBySingle(secondPadding, ZoneHeightChangeCard("def16Height"))
        }
